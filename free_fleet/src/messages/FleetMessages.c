...
static const uint32_t FreeFleetData_Header_ops [] =
{
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof (FreeFleetData_Header, seq),
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_Header, frame_id),
  DDS_OP_RTS
};

const dds_topic_descriptor_t FreeFleetData_Header_desc =
{
  sizeof (FreeFleetData_Header),
  sizeof (char *),
  DDS_TOPIC_NO_OPTIMIZE,
  0u,
  "FreeFleetData::Header",
  NULL,
  3,
  FreeFleetData_Header_ops,
  "<MetaData version=\"1.0.0\"><Module name=\"FreeFleetData\"><Struct name=\"Header\"><Member name=\"seq\"><ULong/></Member><Member name=\"frame_id\"><String/></Member></Struct></Module></MetaData>"
};


static const uint32_t FreeFleetData_ImagePixel_ops [] =
{
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof (FreeFleetData_ImagePixel, pixel),
  DDS_OP_RTS
};

const dds_topic_descriptor_t FreeFleetData_ImagePixel_desc =
{
  sizeof (FreeFleetData_ImagePixel),
  4u,
  0u,
  0u,
  "FreeFleetData::ImagePixel",
  NULL,
  2,
  FreeFleetData_ImagePixel_ops,
  "<MetaData version=\"1.0.0\"><Module name=\"FreeFleetData\"><Struct name=\"ImagePixel\"><Member name=\"pixel\"><ULong/></Member></Struct></Module></MetaData>"
};


static const uint32_t FreeFleetData_RobotImage_ops [] =
{
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_RobotImage, fleet_name),
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_RobotImage, robot_name),
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof (FreeFleetData_RobotImage, image_header.seq),
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_RobotImage, image_header.frame_id),
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof (FreeFleetData_RobotImage, height),
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof (FreeFleetData_RobotImage, width),
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_RobotImage, encoding),
  DDS_OP_ADR | DDS_OP_TYPE_BOO, offsetof (FreeFleetData_RobotImage, is_bigendian),
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof (FreeFleetData_RobotImage, step),
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (FreeFleetData_RobotImage, data),
  sizeof (FreeFleetData_ImagePixel), (7u << 16u) + 4u,
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof (FreeFleetData_ImagePixel, pixel),
  DDS_OP_RTS,
  DDS_OP_RTS
};

const dds_topic_descriptor_t FreeFleetData_RobotImage_desc =
{
  sizeof (FreeFleetData_RobotImage),
  sizeof (char *),
  DDS_TOPIC_NO_OPTIMIZE,
  0u,
  "FreeFleetData::RobotImage",
  NULL,
  14,
  FreeFleetData_RobotImage_ops,
  "<MetaData version=\"1.0.0\"><Module name=\"FreeFleetData\"><Struct name=\"Header\"><Member name=\"seq\"><ULong/></Member><Member name=\"frame_id\"><String/></Member></Struct><Struct name=\"ImagePixel\"><Member name=\"pixel\"><ULong/></Member></Struct><Struct name=\"RobotImage\"><Member name=\"fleet_name\"><String/></Member><Member name=\"robot_name\"><String/></Member><Member name=\"image_header\"><Type name=\"Header\"/></Member><Member name=\"height\"><ULong/></Member><Member name=\"width\"><ULong/></Member><Member name=\"encoding\"><String/></Member><Member name=\"is_bigendian\"><Boolean/></Member><Member name=\"step\"><ULong/></Member><Member name=\"data\"><Sequence><Type name=\"ImagePixel\"/></Sequence></Member></Struct></Module></MetaData>"
};
