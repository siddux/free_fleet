...
extern const dds_topic_descriptor_t FreeFleetData_Header_desc;

#define FreeFleetData_Header__alloc() \
((FreeFleetData_Header*) dds_alloc (sizeof (FreeFleetData_Header)));

#define FreeFleetData_Header_free(d,o) \
dds_sample_free ((d), &FreeFleetData_Header_desc, (o))


typedef struct FreeFleetData_ImagePixel
{
  uint32_t pixel;
} FreeFleetData_ImagePixel;

extern const dds_topic_descriptor_t FreeFleetData_ImagePixel_desc;

#define FreeFleetData_ImagePixel__alloc() \
((FreeFleetData_ImagePixel*) dds_alloc (sizeof (FreeFleetData_ImagePixel)));

#define FreeFleetData_ImagePixel_free(d,o) \
dds_sample_free ((d), &FreeFleetData_ImagePixel_desc, (o))

typedef struct FreeFleetData_RobotImage_data_seq
{
  uint32_t _maximum;
  uint32_t _length;
  FreeFleetData_ImagePixel *_buffer;
  bool _release;
} FreeFleetData_RobotImage_data_seq;

#define FreeFleetData_RobotImage_data_seq__alloc() \
((FreeFleetData_RobotImage_data_seq*) dds_alloc (sizeof (FreeFleetData_RobotImage_data_seq)));

#define FreeFleetData_RobotImage_data_seq_allocbuf(l) \
((FreeFleetData_ImagePixel *) dds_alloc ((l) * sizeof (FreeFleetData_ImagePixel)))
...
typedef struct FreeFleetData_RobotImage
{
  ...
  bool is_bigendian;
  uint32_t step;
  FreeFleetData_RobotImage_data_seq data;
} FreeFleetData_RobotImage;

extern const dds_topic_descriptor_t FreeFleetData_RobotImage_desc;

#define FreeFleetData_RobotImage__alloc() \
((FreeFleetData_RobotImage*) dds_alloc (sizeof (FreeFleetData_RobotImage)));

#define FreeFleetData_RobotImage_free(d,o) \
dds_sample_free ((d), &FreeFleetData_RobotImage_desc, (o))
